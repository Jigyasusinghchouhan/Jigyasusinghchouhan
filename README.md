<div align="center">
  <img src="https://cdn.dribbble.com/userupload/7725814/file/original-ad34e5a3d587a8a90b6586de67710225.gif" alt="DevOps Banner" width="100%" />
</div>
...
| ☁️ Cloud | 🧪 CI/CD | 🐳 Containers | 📈 Monitoring | ⚙️ Automation |
|---------|----------|----------------|---------------|---------------|
...
- **CI/CD & DevOps Tools:** Jenkins, GitHub Actions, GitLab CI/CD, Docker, Maven, SonarQube, Git, Bitbucket
- **Cloud Platforms:** AWS (EC2, S3, RDS, ALB, ELB, IAM, VPC, Route53, CloudWatch, DynamoDB), Azure, Azure DevOps
- **Infrastructure & Configuration:** YAML, Linux, Bash, Apache Tomcat, NGINX
- **Monitoring & Logging:** Grafana, Prometheus, New Relic, AWS CloudWatch
- **Version Control & Tracking:** GitHub, GitLab, Bitbucket, Jira, GitBash
- **Project Management:** Asana, Agile/Scrum
- **Other Skills:** CI/CD Pipelines, Containerization, DevSecOps, Infrastructure as Code (IaC), Security Best Practices, Automation, Production Support, System Monitoring, Troubleshooting, Deployment Automation
...
- **Responsibilities:**
  ...
  - Configured and maintained Docker containers and Kubernetes clusters
  - Led monitoring and alerting systems with Prometheus and Grafana
  - Managed Infrastructure as Code (IaC) using Terraform and Ansible
  - Collaborated in Agile teams for deployment automation and system performance optimization
...
<p align="center">
  <a href="https://www.linkedin.com/in/jigyasusinghchouahn" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-blue?logo=linkedin&style=for-the-badge" />
  </a>
  <a href="https://instagram.com/jigyasu_singh_" target="_blank">
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Jigyasusinghchouhan&theme=dark&hide_border=false&include_all_commits=true&count_private=true)

---

![GitHub Streak Stats](https://github-readme-streak-stats.herokuapp.com/?user=Jigyasusinghchouhan&theme=dark&hide_border=false)
